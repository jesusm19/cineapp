                    ...
                    <tbody>
                        <c:forEach items="${ horarios }" var="horarios"> 
                            <tr>
                                ...
                                <td>${ horarios.hora } hrs.</td>
                                <td>${ horarios.nombreSala }</td>
                                ...
                                <td>
                                    ...
                                    <a href="delete/${ horarios.id }" onclick="return confirm(&quot;¿Estas seguro?&quot;)" class="btn btn-danger btn-sm" role="button" title="Eliminar"><span><i class="far fa-trash-alt fa-lg"></i></span></a>
                                </td>
                            </tr>
                        </c:forEach>
                    </tbody>
